...
const PropertyDetail = ({ property, auth }) => {
    ...
    const themeClasses = {
        text: property?.purchase === 'For Rent' ? 'text-green-600' : 'text-blue-600',
        heading: property?.purchase === 'For Rent' ? 'text-green-700' : 'text-blue-700',
        hover: property?.purchase === 'For Rent' ? 'hover:text-green-700' : 'hover:text-blue-700',
        button: property?.purchase === 'For Rent' ? 'bg-green-600 hover:bg-green-700' : 'bg-blue-600 hover:bg-blue-700',
        searchButton: property?.purchase === 'For Rent' ? 'bg-green-500 hover:bg-green-600' : 'bg-blue-500 hover:bg-blue-600'
    };
                        ...
                        <div className="p-8">
                            <div className="flex justify-between items-start mb-8">
                                <div>
                                    <h1 className="text-3xl font-bold text-gray-900 mb-2 flex items-center">
                                        <svg className={`w-8 h-8 mr-3 ${themeClasses.text}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div className="text-right">
                                    <p className={`text-3xl font-bold ${themeClasses.text} flex items-center justify-end`}>
                                        <svg className="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                        {property?.purchase === 'For Rent' ? 
                                        (<>RM {Number(property?.price || 0).toLocaleString()} /month</>
                                        ) : (
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                                <div className="bg-gray-50 p-6 rounded-lg hover:bg-gray-100 transition-colors duration-300">
                                    <h2 className={`text-lg font-semibold mb-4 flex items-center ${themeClasses.heading}`}>
                                        <svg className="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
                <div className="bg-white shadow-xl rounded-xl p-6">
                    <h2 className="text-xl font-semibold mb-6 flex items-center text-gray-800">
                        <svg className={`w-6 h-6 mr-2 ${themeClasses.text}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                        </svg>
                        Location
                    ...
                    <Map 
                        ...
                        theme={property?.purchase === 'For Rent' ? 'green' : 'blue'}
                    />
