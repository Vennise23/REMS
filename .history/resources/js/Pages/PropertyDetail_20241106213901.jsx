...
const PropertyDetail = ({ property, auth }) => {
    ...
    const initializeMap = () => {
        // 组合完整地址
        const fullAddress = `${property.property_address_line_1} ${property.property_address_line_2 || ''} ${property.city} ${property.postal_code}`;

        // 使用 Geocoding 服务将地址转换为坐标
